...
class EmpleadoDepartamentoNotFoundIntegrationTest extends AbstractIntegrationTest {
    ...
    void setup() {
        ...
        auth.setNombre("dep404");
        auth.setEmail("dep404@example.com");
    ...
    @Test
    void shouldReturnNotFoundWhenAssigningMissingDepartment() throws Exception {
        Map<String, Object> payload = Map.of(
            ...
            "email", "nuevo@example.com",
                ...
                "telefono", "tel",
                "contrasena", "Abcdef1!",
                "departamentoClave", 99999
        );

        mockMvc.perform(post("/api/v1/empleados")
                        .with(httpBasic("dep404@example.com", "Abcdef1!"))
