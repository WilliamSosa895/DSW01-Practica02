...
**Language/Version**: Java 17 (MUST; constitution)  
**Primary Dependencies**: Spring Boot, Spring Security (Basic Auth), springdoc-openapi (Swagger)  
**Storage**: PostgreSQL (MUST; provisioned locally with Docker)  
**Testing**: JUnit 5 + Spring Boot Test (unit/integration as applicable)  
**Target Platform**: Linux container / JVM server runtime
